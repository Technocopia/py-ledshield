...
def testopencv2():
    ...
    fgbg = cv2.createBackgroundSubtractorMOG2(history=12000, varThreshold=32, detectShadows=False)
    while(1):
        ret, frame = cap.read()
...
def testopencv3():
    ...
    while(1):
        ...
        # print(hullIndexes)
        hulls = [cv2.convexHull(contour) for contour in contours if cv2.arcLength(contour, True)> ARC_THRESHOLD]
